...
#define FIXED_SHIFT     14
    ...
    #define USE_FMT     (LVL_FMT_PHD | LVL_FMT_PKD)
...
#if defined(__RETROGO__)
    #define ADDR_ALIGN4(x) ((decltype(x))(((intptr_t)(x) + 3) & ~3))
#else
...
#if defined(__GBA__) || defined(__NDS__) || defined(__32X__) || defined(__RETROGO__)
