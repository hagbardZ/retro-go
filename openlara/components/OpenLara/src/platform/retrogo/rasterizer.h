#ifndef H_RASTERIZER_RETROGO
#define H_RASTERIZER_RETROGO
    ...
    while (1)
    {
        while (!Lh)
        {
            ...
            if (Lh > 1)
            {
                ...
                Ldx = tmp * (N->v.x - Lx);
                uint32 duv = N->t.t - Lt;
                uint32 du = tmp * (int16_t)(duv >> 16);
                uint32 dv = tmp * (int16_t)(duv);
        ...
        while (h--)
        {
            ...
            if (width > 0)
            {
                ...
                if (width & 1)
                {
                    uint32 tmp_t = Rt - dtdx;
                    *(uint16*)(ptr + width - 1) = (ptr[width] << 8) | ft_lightmap[gTile[(tmp_t & 0xFF00) | (tmp_t >> 24)]];
                }
                width >>= 1;
                while (width--)
                {
    ...
    while (1)
    {
        ...
        while (h--)
        {
            ...
            if (width > 0)
            {
                ...
                uint32 duv = Rt - Lt;
                uint32 u_inc = tmp * (int16_t)(duv >> 16);
                uint32 v_inc = tmp * (int16_t)(duv);
                uint32 dtdx = (u_inc & 0xFFFF0000) | (v_inc >> 16);
                int32 g = Lg;
                uint32 t = Lt;
                volatile uint8* ptr = (uint8*)pixel + x1;
                ...
                {
                    uint32 tmp_t = Rt - dtdx;
                    *(uint16*)(ptr + width - 1) = (ptr[width] << 8) | gLightmap[(Rg >> 8 << 8) | gTile[(tmp_t & 0xFF00) | (tmp_t >> 24)]];
                }
                width >>= 1;
                while (width--)
                {
    ...
    while (1)
    {
        ...
        while (h--)
        {
            ...
            if (width > 0)
            {
                ...
                {
                    uint32 tmp_t = Rt - dtdx;
                    uint8 p = gTile[(tmp_t & 0xFF00) | (tmp_t >> 24)];
                    if (p) {
    ...
    while (1)
    {
        ...
        while (h--)
        {
            ...
            if (width > 0)
            {
                ...
                {
                    uint32 tmp_t = Rt - dtdx;
                    uint8 indexA = gTile[(tmp_t & 0xFF00) | (tmp_t >> 24)];
                    if (indexA) {
