...
DEFAULT_APPS = os.getenv("RG_TOOL_APPS", "launcher retro-core prboom-go snes9x gwenesis fmsx gbsp ngp-go bootstrap duke3d-go stella openlara opentyrian celeste quake-go cannonball classicube sm64-go mp3-player frodo")
