 /****************************************************************************
 * Target definition for Martendo32
 * Guide: https://github.com/hagbardZ/Martendo32
 * Command to build: python rg_tool.py --target martendo32-hdmi build-img --no-networking
 ****************************************************************************/
#define RG_TARGET_NAME             "MARTENDO32-HDMI"
...
#define RG_SCREEN_SPEED             SPI_MASTER_FREQ_40M // SPI_MASTER_FREQ_40M or SPI_MASTER_FREQ_80M
