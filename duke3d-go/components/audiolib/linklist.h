...
#define LL_AddNode(rootnode, newnode, next, prev) 			\
   {                                              			\
   (newnode)->next = (void *)(rootnode);                  			\
   (newnode)->prev = (void *)(rootnode)->prev;                	\
   (rootnode)->prev->next = (void *)(newnode);                	\
   (rootnode)->prev = (void *)(newnode);                      	\
   }
...
#define LL_RemoveNode(node,next,prev) \
   {                                  \
   (node)->prev->next = (void *)(node)->next;     \
   (node)->next->prev = (void *)(node)->prev;     \
   (node)->next = (void *)(node);                 \
   (node)->prev = (void *)(node);                 \
   }
