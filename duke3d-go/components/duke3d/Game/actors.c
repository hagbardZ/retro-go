                ...
                case 10:    // Player
                    ...
                    if( sprite[j].owner != -1 )
                    {
                        ...
                        if(onfloorz == 0 && klabs(SZ-ps[p].posz) < 6144 )
                            if( (ps[p].jetpack_on == 0 ) || (ps[p].jetpack_on && (dukeSyncArray[p].bits&1) ) ||
                                (ps[p].jetpack_on && (dukeSyncArray[p].bits&2) ) )
                        {
                            ps[p].oposx = ps[p].posx += sprite[OW].x-SX;
                            ps[p].oposy = ps[p].posy += sprite[OW].y-SY;

                            if( ps[p].jetpack_on && ( (dukeSyncArray[p].bits&1) || ps[p].jetpack_on < 11 ) )
                        ...
                        if( onfloorz && sectlotag == 1 && ps[p].on_ground && ps[p].posz > (sector[sect].floorz-(16<<8)) && ( (dukeSyncArray[p].bits&2) || ps[p].poszv > 2048 ) )
...
//                        if(s->pal == 12)
                        {
                            ...
                            if( j > -64 && j < 64 && (dukeSyncArray[p].bits&(1<<29)) )
...
// #endif
                ...
                if(t[0] == -4) //On the player
                {
                    ...
                    if( ( (dukeSyncArray[p].bits&4) || (ps[p].quick_kick > 0) ) && sprite[ps[p].i].extra > 0 )
